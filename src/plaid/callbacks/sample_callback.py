...
# from ..evaluation import RITAPerplexity, parmar_fid, parmar_kid
# from ..utils import write_pdb_to_disk, npy
...
# class SampleCallback(ABC, Callback):
#     """Abstract class that has an run attribute that must be implemented and callable 
#     both from main and on_train_epoch_end.
#     """
#     def __init__(self):
#         pass
...
# class SampleLatentCallback(SampleCallback):
#     def __init__(self, calc_fid: bool):
#         pass

# class ConditionalSampleLatentCallback(Callback):
#     def __init__(self):
#         pass


# class SampleLatentToStructureCallback(Callback):
#     pass

# class SampleLatentToSequenceCallback(Callback):
#     pass
...
# #     def _load_saved_features(self, device):
# #         pass
...
# #         # uncompress
# #         uncompressed = self.hourglass_model.uncompress(x).detach()
