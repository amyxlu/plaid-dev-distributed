...
seq_mode_config = mlc.ConfigDict(
    {
        "data": {
            "common": {
                ...
                "seqemb_features": ["seq_embedding"],  # List of features to be generated in seqemb mode
            },
            "seqemb_mode": {  # Configuration for sequence embedding mode
        ...
        "model": {
            ...
            "evoformer_stack": {"no_column_attention": True},  # Turn off Evoformer's column attention
        },
    }
)
