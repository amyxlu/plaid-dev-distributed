...
# python run_diffusion_slrm.py --n_gpus 4 --flags "experiment=hdif/cached_pfam_ddp ++datamodule.h5_root_dir=/homefs/home/lux70/storage/data/pfam/compressed/subset_30K_with_clan ++datamodule.batch_size=128 ++denoiser.use_self_conditioning=True ++trainer.devices=[0,1,2,3]" 
