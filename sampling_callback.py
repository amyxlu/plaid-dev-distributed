...
from k_diffusion.config import ModelConfig
import pandas as pd


BASE_ARTIFACT_DIR = Path("/shared/amyxlu/kdplaid")
...
class SampleCallback:
    ...
    def _save_setup(self, base_artifact_dir=BASE_ARTIFACT_DIR):
    ...
    def _wandb_setup(self):
        print(f"Setting up wandb logging for model {self.config.model_id}...")
        wandb.init(
            id=self.config.model_id, resume="allow", project="kdplaid", entity="amyxlu"
        )
